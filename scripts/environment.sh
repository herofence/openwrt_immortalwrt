...
sudo apt-get full-upgrade -qq -y
...
sudo apt-get install -y \
  ...
  python3-setuptools qemu-utils re2c rsync scons squashfs-tools subversion swig texinfo \
  uglifyjs upx-ucl unzip vim wget xmlto xxd zlib1g-dev zstd
